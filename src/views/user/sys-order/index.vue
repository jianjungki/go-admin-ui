    ...
    <template #wrapper>
      <el-card class="box-card">
        ...
        <el-table v-loading="loading" :data="sysOrderList" @selection-change="handleSelectionChange">
          ...
          <el-table-column label="订单id" width="80" align="center" prop="id" />
          <el-table-column label="订单费用" align="center" prop="pay_fee" />
          <el-table-column label="订单状态" align="center" prop="status" />
          <el-table-column label="退款费用" align="center" prop="refund_fee" />
        ...
        <el-dialog :title="title" :visible.sync="open" width="500px">
          <el-form ref="form" :model="form" :rules="rules" label-width="80px">
            ...
            <el-form-item label="" prop="payParams">
              <el-input
                v-model="form.payParams"
                placeholder=""
              />
            </el-form-item>
            <el-form-item label="" prop="retParams">
              <el-input
                v-model="form.retParams"
                placeholder=""
              />
            </el-form-item>
